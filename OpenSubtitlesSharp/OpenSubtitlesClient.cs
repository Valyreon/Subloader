...
public class OpenSubtitlesClient : IOpenSubtitlesClient, IDisposable
{
    ...
    private const string _defaultBaseUrl = "https://api.opensubtitles.com/api/v1/";
    private const string _vipBaseUrl = "https://vip-api.opensubtitles.com/api/v1/";
    ...
    /// <summary>
    /// Creates an instance of OpenSubtitlesClient.
    /// </summary>
    /// <param name="apiKey">You consumer API Key generated by OpenSubtitles.com</param>
    ...
    /// <inheritdoc />
    /// <exception cref="InvalidOperationException">Thrown when the JWT token is not provided.</exception>
    ...
    /// <inheritdoc />
    /// <remarks>The method will calculate the hash of the movie and try to extract info from the file name
    /// such as year, season, episode and other keywords.</remarks>
    /// <exception cref="ArgumentException">Thrown when file path is not provided or the file does not exist.</exception>
    ...
    private static string BuildGetQueryURL(IReadOnlyDictionary<string, string> paramsDict)
    {
